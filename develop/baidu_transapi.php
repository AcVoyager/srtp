...
define("APP_ID",         "20180511000157144"); //替换为您的APPID
define("SEC_KEY",        "pxbix4Jw6V7B1NXpnrFU");//替换为您的密钥
...
//$result = translate("My name is van and I'm a performance artist.", "en", "zh");
//var_dump($result);
